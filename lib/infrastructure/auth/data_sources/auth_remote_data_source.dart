...
import 'package:base_app/infrastructure/_commons/exceptions.dart';
import 'package:base_app/infrastructure/_commons/network/app_http_service.dart';
import 'package:base_app/infrastructure/_commons/network/app_requests.dart';
import 'package:base_app/infrastructure/_commons/throw_error.dart';
import 'package:base_app/infrastructure/auth/dtos/auth_response/auth_response_dto.dart';
...
class AuthRemoteDataSource implements IAuthRemoteDataSource {
  ...
  Future<Unit> updatePassword(
    ...
    Response response =
        await httpClient.putRequest(request, body: json.decode(body));
    if (response.statusCode == 200 || response.statusCode == 201) {
      return unit;
    } else {
      throw ServerException(errorThrow(response));
